...
//     };
//
//     struct key_vector_visitor : public boost::static_visitor<SEXP> {
//         int n;
...
//     };
//
//     struct value_vector_visitor : public boost::static_visitor<SEXP> {
//         int n;
...
//     };
//
//     struct left_outer_join_visitor : public boost::static_visitor<SEXP> {
//         const HashMap& other;
