...
fast, and `environment`s are highly flexible, allowing on to store 
...
```
This is rather unfortunate considering R's overwheleming tendency 
...
two important areas: performance and ease-of-use. 
